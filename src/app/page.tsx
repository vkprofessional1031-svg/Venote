      ...
      <section className="py-24 px-6 md:px-12 bg-card border-y border-hairline relative overflow-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            {/* Feature 5 */}
            <div className="bg-background border border-hairline rounded-[24px] p-8 md:p-10 shadow-xl hover:border-[#8B5CF6]/30 transition-colors md:col-span-2 md:w-[calc(50%-1.5rem)] md:mx-auto">
              <div className="w-12 h-12 rounded-xl bg-[#8B5CF6]/10 flex items-center justify-center mb-6 text-[#8B5CF6]">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="font-sans font-bold text-2xl mb-3">Interview Prep</h3>
              <p className="text-muted-text leading-relaxed">
